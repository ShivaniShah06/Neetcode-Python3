...
class Solution:
    ...
    def longestChar_more_efficient(self, s: str, k: int) -> int:
        # The optimisation with max_frequency works like this: 
        # For a substring to be valid, we need window_length - maxf <= k. Here, maxf is the frequency of the most common character in the current window. 
        ...
        # The biggest valid substring we can get is of size maxf + k. So, the larger maxf is, the better. 
        # If maxf doesn't change or goes down, our potential best answer doesn't change. We don't need to update maxf in this case.
